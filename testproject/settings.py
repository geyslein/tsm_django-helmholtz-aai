...
SECRET_KEY = (
    "django-insecure-hvc15^@@u5rsx!2qm+^b=8u2@inu&_ye1v)p&5o6piyck-g6o@"
)
...
# HACK to make it working in the code-server
FORCE_SCRIPT_NAME = os.getenv("FORCE_SCRIPT_NAME", "/proxy/8000/")
